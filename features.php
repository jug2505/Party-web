...
<!-- Форма администрирования -->
  <form>
    <h2 style="margin: 10px; text-align: center;">Функции:</h2>
    <a style="margin: 10px; text-align: center;" href="search.php">Поиск по сайту</a>
    <a style="margin: 10px; text-align: center;" href="eventForTown.php">Узнать события по городу</a>
